...
if ("stockCount" >= 1, "I'm going to eat some [food]!"){
}
  else ("We need to get some more [food].")
...
var vegetables = ["carrot", "lettuce", "cucumber", "peas", "greenbeans"]
...
// different fruits.
var fruits = ["apple", "banana", "tomato", "strawberry", "peach", "kiwi", "blueberry"]
